...
const schema: EnvSchema = {
    ...
    PUBLIC_PADDLE_INDIVIDUAL_MONTHLY_PRICE_ID: publicString,
    PUBLIC_PADDLE_INDIVIDUAL_ANNUAL_PRICE_ID: publicString,
    PUBLIC_PADDLE_ORG_MONTHLY_SEAT_PRICE_ID: publicString,
    PUBLIC_PADDLE_ORG_ANNUAL_SEAT_PRICE_ID: publicString,
